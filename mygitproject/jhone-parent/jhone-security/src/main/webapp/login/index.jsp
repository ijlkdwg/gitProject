...
<!--页面插件css-->
<!-- text fonts -->
<link rel="stylesheet" href="<%=request.getContextPath()%>/bootstrap/css/ace-fonts.css" />
<!-- ace 样式  -->
<link rel="stylesheet" href="<%=request.getContextPath()%>/bootstrap/css/ace.min.css" id="main-ace-style" />
<!--[if lte IE 9]>
...
<!-- #section:basics/navbar.dropdown -->
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav">
						...
						<li class="purple">
							<a data-toggle="dropdown" class="dropdown-toggle" href="#">
								<i class="icon-bell icon-animated-bell"></i>
						...
						<li class="green">
							<a data-toggle="dropdown" class="dropdown-toggle" href="#">
								<i class="icon-envelope animated-vertical"></i>
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="<%=request.getContextPath()%>/static/image/100/07.png" alt="Jason's Photo" />
...
<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar responsive">
						...
						<a href="calendar.html">
							...
							<span class="menu-text">
								...
								<span class="badge badge-transparent tooltip-error" title="2 Important Events">
									<i class="icon-exclamation-triangle red bigger-130"></i>
								</span>
				...
				<div class="sidebar-toggle sidebar-collapse" id="sidebar-collapse">
					<i class="ace-icon-angle-double-left" data-icon1="icon-angle-double-left" data-icon2="icon-angle-double-right"></i>
				</div>
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="clearfix">
														...
														<div class="grid3">
															<span class="grey">
																<i class="icon-facebook-square fa-2x blue"></i>
																&nbsp; likes
															</span>
														...
														<div class="grid3">
															<span class="grey">
																<i class="icon-twitter-square fa-2x purple"></i>
																&nbsp; tweets
															</span>
														...
														<div class="grid3">
															<span class="grey">
																<i class="icon-pinterest-square fa-2x red"></i>
																&nbsp; pins
															</span>
												...
												<div class="widget-main padding-4">
													<div class="tab-content padding-8">
															...
															<ul id="tasks" class="item-list">
																...
																<li class="item-red clearfix">
																	...
																	<div class="pull-right action-buttons">
																		...
																		<a href="#" class="red">
																			<i class="icon-trash-o bigger-130"></i>
																		</a>
																		...
																		<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-caret dropdown-close dropdown-menu-right">
																			...
																			<li>
																				<a href="#" class="tooltip-error" data-rel="tooltip" title="Delete">
																					<span class="red">
																						<i class="icon-trash-o bigger-110"></i>
																					</span>
																				</a>
																			</li>
																		</ul>
														...
														<div id="member-tab" class="tab-pane">
																				...
																				<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																					...
																					<li>
																						<a href="#" class="tooltip-warning" data-rel="tooltip" title="Reject">
																							<span class="orange">
																								<i class="icon-times bigger-110"></i>
																							</span>
																						</a>
																					</li>
															...
															<div class="center">
																<i class="icon-users fa-2x green middle"></i>
														...
														<div id="comment-tab" class="tab-pane">
															...
															<div class="center">
																<i class="icon-comments-o fa-2x green middle"></i>
															...
															<div class="body">
																...
																<div class="tools">
																	<a href="#" class="btn btn-minier btn-info">
																		<i class="icon-only icon-share"></i>
																	</a>
																</div>
															</div>
														</div>
...
<![endif]-->
		...
		<!--[if lte IE 8]>
		  <script src="<%=request.getContextPath()%>/bootstrap/js/excanvas.min.js"></script>
		<![endif]-->
		<script src="<%=request.getContextPath()%>/bootstrap/js/jquery-ui.custom.min.js"></script>
		<script src="<%=request.getContextPath()%>/bootstrap/js/jquery.ui.touch-punch.min.js"></script>
		<script src="<%=request.getContextPath()%>/bootstrap/js/jquery.easypiechart.min.js"></script>
		<script src="<%=request.getContextPath()%>/bootstrap/js/jquery.sparkline.min.js"></script>
		<script src="<%=request.getContextPath()%>/bootstrap/js/flot/jquery.flot.min.js"></script>
		<script src="<%=request.getContextPath()%>/bootstrap/js/flot/jquery.flot.pie.min.js"></script>
		<script src="<%=request.getContextPath()%>/bootstrap/js/flot/jquery.flot.resize.min.js"></script>

		<!-- ace scripts -->
		<script src="<%=request.getContextPath()%>/bootstrap/js/ace-elements.min.js"></script>
		<script src="<%=request.getContextPath()%>/bootstrap/js/ace.min.js"></script>
<!-- inline scripts related to this page -->
		...
		<link rel="stylesheet" href="<%=request.getContextPath()%>/bootstrap/css/sunburst.css" />
 		<script type="text/javascript"> ace.vars['base'] = '..'; </script>
		<script src="<%=request.getContextPath()%>/bootstrap/js/elements.onpage-help.js"></script>
		<script src="<%=request.getContextPath()%>/bootstrap/js/ace.onpage-help.js"></script>
		<script src="<%=request.getContextPath()%>/bootstrap/js/rainbow.js"></script>
		<script src="<%=request.getContextPath()%>/bootstrap/js/language/generic.js"></script>
		<script src="<%=request.getContextPath()%>/bootstrap/js/language/html.js"></script>
		<script src="<%=request.getContextPath()%>/bootstrap/js/language/css.js"></script>
		<script src="<%=request.getContextPath()%>/bootstrap/js/language/javascript.js"></script>
</body>
</html>
